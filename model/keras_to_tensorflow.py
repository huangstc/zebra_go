...
def LoadModel(input_model_path, input_json_path=None, input_yaml_path=None):
...
def main(args):
    ...
    model = LoadModel(FLAGS.input_model, FLAGS.input_model_json, FLAGS.input_model_yaml)
